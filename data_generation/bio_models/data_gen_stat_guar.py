...
model_name = "SIR" # choose between: SIR, PrGeEx, PRDeg
list_params = ["beta"] # choose ["beta"], ["gamma"] or ["beta","gamma"] for SIR case study
                          # choose ["k2"], ["k7"] or ["k2","k7"] for PrGeEx case study
                          # choose ["k1"], ["k1","k2","k3"], ["k1","k2","k3","k4"] or ["kp", "kd"] for PRDeg case study
train_flag = True # if True generate training data else generate validation data
...
gen = get_pac_generator(model_name, list_params, latin_flag, train_flag, n_points, n_obs)
...
print(model_name, list_params, latin_flag, train_flag, n_points, n_obs)